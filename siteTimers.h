...
extern double timeSiteCluster(char** lattice, int size, double chance, unsigned long long *largestClusterSize, int* perc, int percType, int numNodes, int numThreads);
